...
function sentiment(text) {
  let positive = text.match(positiveRegex).map(toLowerCase);
  let negative = text.match(negativeRegex).map(toLowerCase);
  let textSentiment = getTextSentiment(positive.length, negative.length);
...
function getTextSentiment(positive, negative) {
